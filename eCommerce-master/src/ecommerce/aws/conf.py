...
# except:
#     AWS_ACCESS_KEY_ID = os.environ.get("AWS_ACCESS_KEY_ID", "AKIAIVC7ESB4LGM74LIA")
#     AWS_SECRET_ACCESS_KEY = os.environ.get("AWS_SECRET_ACCESS_KEY", "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 ")
#
